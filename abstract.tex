...
However,
applications make so many requests to external entities during execution that
it is difficult to recognize and respond to patterns that indicate the
potential for failure.
We propose that event processing techniques,
which are capable of identifying patterns of interest in other domains,
are a solution to
this problem.
This work demonstrates how CSlang,
our new domain specific language can harness
these techniques to identify
bugs.
CSlang allows users to construct programs
that can identify patterns in system call recordings and other streams,
...
and showing how CSlang can be used
