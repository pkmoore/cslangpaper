...
the PORT language is sufficiently expressive
...
mutator.
As illustrated in Figure~\ref{lst:UnusualFiletypePORT},this mutator
...
of Python code.
When we compared our PORT code to the original mutator, it became apparent that there were
several major advantages
to writing a mutator with
...
preserves all of a file's extended attributes and re-applies them to the
...
Adding support for JSONRPC by creating an appropriate transformer required a handful of hours of effort. Implementing the XMLRPC transformer,
...
from other work.
For this experiment, we selected the work of Dornhackl et al.~\cite{Dornhackl2014}
in describing and detecting malicious behavior in Windows
applications.  This work
...
time our prototype implementation, 
required
