...
We did, however, identify one point of friction -- keyboard scan codes are cumbersome to work with directly.
Future work could employ meta-programming to further simplify the manipulation of lower level activity representations.
