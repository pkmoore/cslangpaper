...
Sekar et al.\cite{DBLP:conf/sp/SekarBDB01} extend the work of \cite{DBLP:conf/sp/ForrestHSL96} by proposing an algorithm and associated optimizations to create a finite state automata that
