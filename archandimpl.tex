...
The PORT implementation consists of several related
...
an application's event activity is recorded on the one hand, and the representation of this event stream
processed by a transducer on the other hand.
