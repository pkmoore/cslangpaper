...
Such flexibility would prevent PORT from being tied to specific recording formats or activity representations, while also making it easier to modify parameters in a format-agnostic fashion.
