...
\centering
\begin{align*}
\mathsf{program} ::= {} &  (\mathsf{typedef} \mid \mathsf{eventdef})^* \; \mathsf{action}^*\\
...
\mathsf{action} ::= {} & \mathsf{pattern} \texttt{ -> } \mathit{id}\,(e) \mid \mathtt{not} \; \mathsf{pattern}\\
\mathsf{pattern} ::= {} & \mathit{id}\,(p) \;\mathtt{with}\; b\\
