...
The PORT language allows its users to completely describe a mutator - a program that can recognize a particular event stream and optionally produce a modified version of that stream.
