...
\begin{quote}
\centering
\textbf{eventdefinition:}
\end{quote}

An eventdefinition statement describes an event that may appear in an input
stream.  This description is used to select the parameters
.....................................

\begin{quote}
\centering
\textbf{variantdefinition:}
\end{quote}
...
Dataword statments are the most complex variety in CSlang and, as such, we
will discuss it one piece at a time.
