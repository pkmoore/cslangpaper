...
\begin{figure}
  \begin{lstlisting}
    ...
    event close {filedesc: Numeric@0,
                    retval: Numeric@ret};
...
PORT and OpenCEP, a CEP module for the Python programming language.
Figure~\ref{fig:PORTListing}
...
of the same program as seen in Figure~\ref{fig:PORTListing}.
